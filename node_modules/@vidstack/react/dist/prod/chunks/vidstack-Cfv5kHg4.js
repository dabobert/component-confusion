...
import { l as listen, d as IS_CHROME, e as IS_IOS, f as canGoogleCastSrc, g as coerceToError, I as IS_SERVER, h as loadScript } from './vidstack-DD0YAtlF.js';
import { p as peek, D as DOMEvent } from './vidstack-CvduS_bi.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-O7SrbBNT.js')).GoogleCastProvider(this.ba, ctx);
  }
  async wm(ctx) {
