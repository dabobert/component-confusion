...
import { h as createScope, s as signal, g as effect, p as peek, j as isString, k as deferredPromise, l as listenEvent, m as isArray } from './vidstack-CvduS_bi.js';
import { T as TimeRange, p as preconnect, L as ListSymbol, b as TextTrack, Q as QualitySymbol } from './vidstack-DD0YAtlF.js';
import { R as RAFLoop } from './vidstack-DWxqfdlP.js';
import { E as EmbedProvider, t as timedPromise } from './vidstack-BTBRWcYx.js';
...
class VimeoProvider extends EmbedProvider {
  ...
  nd(duration, trigger) {
    const { $iosControls } = this.b, { controls } = this.b.$state, showEmbedControls = controls() || $iosControls();
  ...
  cl() {
    if (!this.Xk)
      return;
    this.b.textTracks.remove(this.Xk);
    this.Xk = null;
  }
